...
var serializers = {
        ...
        '_nsName': {
                encoder: function(v) {
                        ...
                        var b = new Buffer.alloc(n.toString().length + 2);
                        var o = 0; //offset
